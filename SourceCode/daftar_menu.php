...
<html lang="en">
  <head>
    ...
    <title>Rumah Makan Mak Ganda</title>
  </head>
  <body>
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">Rumah Makan Mak Ganda</span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="index.php"><strong>Rumah</strong> makan Mak Ganda</a>
        ...
        <div class="row mt-3">
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Lele Goreng</h5>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Ikan Asam Manis</h5>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Babi Panggang</h5>
                <label class="card-text">Rp. 25.000/porsi</label><br>
                <a href="#" class="btn btn-primary btn-sm">EDIT</a>
                <a href="#" class="btn btn-danger btn-sm">HAPUS</a>
              </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Ayam Goreng</h5>
                <label class="card-text">Rp. 1o.000</label><br>
                <a href="#" class="btn btn-primary btn-sm">EDIT</a>
                <a href="#" class="btn btn-danger btn-sm">HAPUS</a>
              </div>
            </div>
         ...
         <div class="row mt-3">
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Ayam Sambal</h5>
                <label class="card-text">Rp. 10.000</label><br>
                <a href="#" class="btn btn-primary btn-sm">EDIT</a>
                <a href="#" class="btn btn-danger btn-sm">HAPUS</a>
              </div>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Ikan Arsik</h5>
                <label class="card-text">Rp. 10.000</label><br>
                <a href="#" class="btn btn-primary btn-sm">EDIT</a>
                <a href="#" class="btn btn-danger btn-sm">HAPUS</a>
              </div>
         ...
         <div class="row mt-3 mb-5">
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Jus Tiung</h5>
                <label class="card-text">Rp. 8.000</label><br>
                <a href="#" class="btn btn-primary btn-sm">EDIT</a>
                <a href="#" class="btn btn-danger btn-sm">HAPUS</a>
              </div>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i>Proyek PABI_2022</p>
          </div>
          </div>
